...
function PropertyDetails({ propertyDetails: { price, rentFrequency, rooms, title, baths, area, agency, isVerified, description, purpose, furnishingStatus, amenities, photos } }) {
    return (
        <Box maxWidth='1000px' margin='auto' p='4'>
            {photos && <ImgScrollBar data={photos} />}
            <Box w='full' p='6'>
